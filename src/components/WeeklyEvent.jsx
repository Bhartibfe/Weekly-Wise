...
const EventModal = ({ 
  ...
  const getTitle = () => {
    switch(modalType) {
      case 'add': return 'Add New Event';
      case 'edit': return 'Edit Event';
      case 'convert': return 'Convert Task to Event';
  ...
  const getButtonText = () => {
    switch(modalType) {
      ...
      case 'convert': return 'Convert to Event';
      default: return 'Save';
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={modalType === 'convert' ? '' : 'grid grid-cols-2 gap-4'}>
          <div className="mb-4">
