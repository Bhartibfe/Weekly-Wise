...
const NoteEditor = () => {
  ...
  useEffect(() => {
    const fetchNoteData = () => {
      ...
      if (savedNotes) {
        ...
        const foundNote = parsedNotes.find(
  ...
  const handleSave = () => {
    ...
    try {
      ...
      const noteIndex = notes.findIndex(
        (n) => n.id.toString() === updatedNote.id.toString()
      );
      if (noteIndex >= 0) {
  ...
  return (
    <div className="p-8 bg-#03030A min-h-screen">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="text-sm text-gray-500 flex items-center">
              ...
              {hasUnsavedChanges && (
                <span className="bg-orange-100 text-orange-600 px-3 py-1 rounded-full mr-2">
                  Unsaved changes
                </span>
              )}
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isTagDropdownOpen && (
                <div className="absolute z-10 mt-1 w-64 bg-white/90 backdrop-blur-md shadow-xl rounded-lg p-3 border border-purple-100">
                  ...
                  <div className="text-purple-600 text-sm mb-1 px-2 font-medium">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    {availableTags.map((tag) => (
                      ...
                      >
                        ...
                        <div
                          className={`px-2 py-0.5 rounded text-sm ${tag.color}`}
                        >
                          {tag.name}
                        </div>
                      </div>
