...
import { Plus, X, Edit2, Smile, CheckSquare } from "lucide-react";
...
const TodoPage = () => {
  ...
  return (
    <div className="min-h-screen bg-#03030A p-8">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Organize your tasks, track progress, complete with ease.
              </p>
            </div>
          </div>
        </div>
          ...
          {Object.values(columns).map((column) => (
            <div
              ...
              className={`rounded-xl p-6 shadow-lg backdrop-blur-sm bg-white/80 
                  ${
                    column.id === "todo"
                      ? "bg-gradient-to-b from-pink-50 to-pink-100/90"
                      : ""
                  }
                  ${
                    column.id === "doing"
                      ? "bg-gradient-to-b from-purple-50 to-purple-100/90"
                      : ""
                  }
                  ${
                    column.id === "done"
                      ? "bg-gradient-to-b from-blue-50 to-blue-100/90"
                      : ""
                  }`}
            >
                        ...
                        {(provided, snapshot) => (
                          <div
                            ...
                            className={`bg-white rounded-lg p-4 mb-3
                                ${
                                  snapshot.isDragging
                                    ? "shadow-lg ring-2 ring-purple-200"
                                    : "shadow-md"
                                }
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              <input
                                ...
                                onChange={() =>
                                  toggleTaskCompletion(task.id, column.id)
                                }
